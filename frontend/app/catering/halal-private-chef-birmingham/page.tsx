...
export const metadata: Metadata = {
  title: 'Halal Private Chef Birmingham | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic halal private chef in Birmingham. 100% halal certified. Pakistani & Indian cuisine. From £35-50pp. Delivery across Birmingham and West Midlands.',
  keywords: 'halal private chef birmingham, halal halal private chef birmingham, pakistani halal private chef birmingham, indian halal private chef birmingham, affordable halal private chef birmingham',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/halal-private-chef-birmingham' },
  openGraph: {
    title: 'Halal Private Chef Birmingham | LUXE VENUE',
    description: 'Authentic halal halal private chef in Birmingham. Pakistani & Indian cuisine from £35-50pp.',
    url: 'https://luxevenue.co.uk/catering/halal-private-chef-birmingham',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function HalalPrivateChefBirminghamPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Halal Private Chef Birmingham',
    description: 'Authentic halal private chef in Birmingham with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/halal-private-chef-birmingham',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does halal private chef cost in Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Halal Private Chef in Birmingham starts from £35-50pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'Is your halal private chef 100% halal?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'What areas do you deliver halal private chef to?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver halal private chef across Birmingham, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for halal private chef in Birmingham. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Halal Private Chef Birmingham', item: 'https://luxevenue.co.uk/catering/halal-private-chef-birmingham' }
    ]
  }
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Halal Private Chef Birmingham
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified halal private chef serving Birmingham. Fresh biryani, karahi, tandoori from £35-50pp
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal halal private chef in Birmingham with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Birmingham families authentic halal halal private chef prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across Birmingham.
                </p>
              </div>
            </div>
          </div>
