...
export const metadata: Metadata = {
  title: 'Asian Catering West Midlands | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic asian catering in West Midlands. 100% halal certified. Pakistani & Indian cuisine. From £15-35pp. Delivery across West Midlands and West Midlands.',
  keywords: 'asian catering west midlands, halal asian catering west midlands, pakistani asian catering west midlands, indian asian catering west midlands, affordable asian catering west midlands',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/asian-catering-west-midlands' },
  openGraph: {
    title: 'Asian Catering West Midlands | LUXE VENUE',
    description: 'Authentic halal asian catering in West Midlands. Pakistani & Indian cuisine from £15-35pp.',
    url: 'https://luxevenue.co.uk/catering/asian-catering-west-midlands',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function AsianCateringWestMidlandsPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Asian Catering West Midlands',
    description: 'Authentic asian catering in West Midlands with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/asian-catering-west-midlands',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'Asian Catering',
    provider: { '@type': 'FoodEstablishment', name: 'LUXE VENUE' },
    areaServed: { '@type': 'City', name: 'West Midlands' },
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does asian catering cost in West Midlands?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Asian Catering in West Midlands starts from £15-35pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'Is your asian catering 100% halal?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'What areas do you deliver asian catering to?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver asian catering across West Midlands, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the minimum order for West Midlands catering?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for asian catering in West Midlands. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Asian Catering West Midlands', item: 'https://luxevenue.co.uk/catering/asian-catering-west-midlands' }
    ]
  }
    ...
    <>
      ...
      <main className="min-h-screen bg-black-primary pt-20">
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Asian Catering West Midlands
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified asian catering serving West Midlands. Fresh biryani, karahi, tandoori from £15-35pp
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="px-10 py-5 rounded-full bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark text-black font-bold text-lg hover:shadow-2xl transition-all">
                Get West Midlands Catering Quote
              </Link>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why West Midlands Families Choose Our Halal Catering
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">West Midlands Catering Challenge</h3>
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal asian catering in West Midlands with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers West Midlands families authentic halal asian catering prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across West Midlands.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Complete Catering Solution for West Midlands
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">
                  Hot food delivered across West Midlands. Professional setup. Free delivery 30+ guests.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Perfect for West Midlands Events
            </h2>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Transparent Pricing for West Midlands
            </h2>
            ...
            <p className="text-gray-400 text-sm text-center mt-6">
              *Minimum 15 guests. Free delivery for 30+ guests in West Midlands
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Delivery Across West Midlands & West Midlands
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
              ...
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
                    <span><strong className="text-white">West Midlands:</strong> All areas covered</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-5 gap-4">
              {['West Midlands', 'Birmingham', 'Wolverhampton', 'Dudley', 'Solihull', 'Walsall', 'West Bromwich', 'Sutton Coldfield', 'Stourbridge', 'Halesowen'].map((area) => (
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why LUXE VENUE for West Midlands Catering
            </h2>
            <div className="overflow-x-auto">
              <table className="w-full bg-surface-dark rounded-xl border border-white/10">
                <thead>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-heading font-bold text-white mb-6">
              Ready to Order from West Midlands?
            </h2>
