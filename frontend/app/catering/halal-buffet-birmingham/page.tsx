...
export const metadata: Metadata = {
  title: 'Halal Buffet Birmingham | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic halal buffet in Birmingham. 100% halal certified. Pakistani & Indian cuisine. From £20-30pp. Delivery across Birmingham and West Midlands.',
  keywords: 'halal buffet birmingham, halal halal buffet birmingham, pakistani halal buffet birmingham, indian halal buffet birmingham, affordable halal buffet birmingham',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/halal-buffet-birmingham' },
  openGraph: {
    title: 'Halal Buffet Birmingham | LUXE VENUE',
    description: 'Authentic halal halal buffet in Birmingham. Pakistani & Indian cuisine from £20-30pp.',
    url: 'https://luxevenue.co.uk/catering/halal-buffet-birmingham',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function HalalBuffetBirminghamPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Halal Buffet Birmingham',
    description: 'Authentic halal buffet in Birmingham with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/halal-buffet-birmingham',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does halal buffet cost in Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Halal Buffet in Birmingham starts from £20-30pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'Is your halal buffet 100% halal?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'What areas do you deliver halal buffet to?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver halal buffet across Birmingham, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for halal buffet in Birmingham. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Halal Buffet Birmingham', item: 'https://luxevenue.co.uk/catering/halal-buffet-birmingham' }
    ]
  }
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Halal Buffet Birmingham
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified halal buffet serving Birmingham. Fresh biryani, karahi, tandoori from £20-30pp
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal halal buffet in Birmingham with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Birmingham families authentic halal halal buffet prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across Birmingham.
                </p>
              </div>
            </div>
          </div>
