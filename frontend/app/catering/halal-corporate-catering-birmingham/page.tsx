...
export const metadata: Metadata = {
  title: 'Halal Corporate Catering Birmingham | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic halal corporate catering in Birmingham. 100% halal certified. Pakistani & Indian cuisine. From £15-30pp. Delivery across Birmingham and West Midlands.',
  keywords: 'halal corporate catering birmingham, halal halal corporate catering birmingham, pakistani halal corporate catering birmingham, indian halal corporate catering birmingham, affordable halal corporate catering birmingham',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/halal-corporate-catering-birmingham' },
  openGraph: {
    title: 'Halal Corporate Catering Birmingham | LUXE VENUE',
    description: 'Authentic halal halal corporate catering in Birmingham. Pakistani & Indian cuisine from £15-30pp.',
    url: 'https://luxevenue.co.uk/catering/halal-corporate-catering-birmingham',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function HalalCorporateCateringBirminghamPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Halal Corporate Catering Birmingham',
    description: 'Authentic halal corporate catering in Birmingham with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/halal-corporate-catering-birmingham',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'Halal Corporate Catering',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does halal corporate catering cost in Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Halal Corporate Catering in Birmingham starts from £15-30pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'Is your halal corporate catering 100% halal?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'What areas do you deliver halal corporate catering to?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver halal corporate catering across Birmingham, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for halal corporate catering in Birmingham. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Halal Corporate Catering Birmingham', item: 'https://luxevenue.co.uk/catering/halal-corporate-catering-birmingham' }
    ]
  }
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Halal Corporate Catering Birmingham
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified halal corporate catering serving Birmingham. Fresh biryani, karahi, tandoori from £15-30pp
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal halal corporate catering in Birmingham with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Birmingham families authentic halal halal corporate catering prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across Birmingham.
                </p>
              </div>
            </div>
          </div>
