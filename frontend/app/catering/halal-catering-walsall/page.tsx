...
export const metadata: Metadata = {
  title: 'Halal Catering Walsall | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic halal catering in Walsall. 100% halal certified. Pakistani & Indian cuisine. From £15-30pp. Delivery across Walsall and West Midlands.',
  keywords: 'halal catering walsall, halal halal catering walsall, pakistani halal catering walsall, indian halal catering walsall, affordable halal catering walsall',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/halal-catering-walsall' },
  openGraph: {
    title: 'Halal Catering Walsall | LUXE VENUE',
    description: 'Authentic halal halal catering in Walsall. Pakistani & Indian cuisine from £15-30pp.',
    url: 'https://luxevenue.co.uk/catering/halal-catering-walsall',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function HalalCateringWalsallPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Halal Catering Walsall',
    description: 'Authentic halal catering in Walsall with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/halal-catering-walsall',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does halal catering cost in Walsall?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Halal Catering in Walsall starts from £15-30pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'Is your halal catering 100% halal?',
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      {
        '@type': 'Question',
        name: 'What areas do you deliver halal catering to?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver halal catering across Walsall, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the minimum order for Walsall catering?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for halal catering in Walsall. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Halal Catering Walsall', item: 'https://luxevenue.co.uk/catering/halal-catering-walsall' }
    ]
  }
    ...
    <>
      ...
      <main className="min-h-screen bg-black-primary pt-20">
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Halal Catering Walsall
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified halal catering serving Walsall. Fresh biryani, karahi, tandoori from £15-30pp
            </p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why Walsall Families Choose Our Halal Catering
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">Walsall Catering Challenge</h3>
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal halal catering in Walsall with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Walsall families authentic halal halal catering prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across Walsall.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Complete Catering Solution for Walsall
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">
                  Hot food delivered across Walsall. Professional setup. Free delivery 30+ guests.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Transparent Pricing for Walsall
            </h2>
            ...
            <p className="text-gray-400 text-sm text-center mt-6">
              *Minimum 15 guests. Free delivery for 30+ guests in Walsall
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Delivery Across Walsall & West Midlands
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
              ...
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
                    <span><strong className="text-white">Walsall:</strong> All areas covered</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why LUXE VENUE for Walsall Catering
            </h2>
            <div className="overflow-x-auto">
              <table className="w-full bg-surface-dark rounded-xl border border-white/10">
                <thead>
