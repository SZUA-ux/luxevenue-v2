...
export const metadata: Metadata = {
  title: 'Pakistani Catering Birmingham | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic pakistani catering in Birmingham. 100% halal certified. Pakistani & Indian cuisine. From £15-25pp. Delivery across Birmingham and West Midlands.',
  keywords: 'pakistani catering birmingham, halal pakistani catering birmingham, pakistani pakistani catering birmingham, indian pakistani catering birmingham, affordable pakistani catering birmingham',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/pakistani-catering-birmingham' },
  openGraph: {
    title: 'Pakistani Catering Birmingham | LUXE VENUE',
    description: 'Authentic halal pakistani catering in Birmingham. Pakistani & Indian cuisine from £15-25pp.',
    url: 'https://luxevenue.co.uk/catering/pakistani-catering-birmingham',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function PakistaniCateringBirminghamPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Pakistani Catering Birmingham',
    description: 'Authentic pakistani catering in Birmingham with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/pakistani-catering-birmingham',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does pakistani catering cost in Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pakistani Catering in Birmingham starts from £15-25pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver pakistani catering across Birmingham, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for pakistani catering in Birmingham. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Pakistani Catering Birmingham', item: 'https://luxevenue.co.uk/catering/pakistani-catering-birmingham' }
    ]
  }
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Pakistani Catering Birmingham
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified pakistani catering serving Birmingham. Fresh biryani, karahi, tandoori from £15-25pp
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal pakistani catering in Birmingham with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Birmingham families authentic halal pakistani catering prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across Birmingham.
                </p>
              </div>
            </div>
          </div>
