...
export const metadata: Metadata = {
  title: 'Halal Catering Dudley | Halal Pakistani & Indian Food from £15pp | LUXE VENUE',
  description: 'Authentic halal catering in Dudley. 100% halal certified. Pakistani & Indian cuisine. From £15-30pp. Delivery across Dudley and West Midlands.',
  keywords: 'halal catering dudley, halal halal catering dudley, pakistani halal catering dudley, indian halal catering dudley, affordable halal catering dudley',
  alternates: { canonical: 'https://luxevenue.co.uk/catering/halal-catering-dudley' },
  openGraph: {
    title: 'Halal Catering Dudley | LUXE VENUE',
    description: 'Authentic halal halal catering in Dudley. Pakistani & Indian cuisine from £15-30pp.',
    url: 'https://luxevenue.co.uk/catering/halal-catering-dudley',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function HalalCateringDudleyPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': ['FoodEstablishment', 'Caterer'],
    name: 'LUXE VENUE - Halal Catering Dudley',
    description: 'Authentic halal catering in Dudley with 100% halal certified Pakistani and Indian cuisine.',
    url: 'https://luxevenue.co.uk/catering/halal-catering-dudley',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does halal catering cost in Dudley?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Halal Catering in Dudley starts from £15-30pp. Our halal menu includes biryani, karahi, curry, naan, rice, and desserts. Free delivery for orders over 30 guests.'
        }
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We deliver halal catering across Dudley, Birmingham, Wolverhampton, Dudley, Solihull, Walsall, and all West Midlands areas. Free delivery for 30+ guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the minimum order for Dudley catering?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Minimum order is 15 people for halal catering in Dudley. We cater for events from 15 to 500+ guests with professional service.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Halal Catering Dudley', item: 'https://luxevenue.co.uk/catering/halal-catering-dudley' }
    ]
  }
    ...
    <>
      ...
      <main className="min-h-screen bg-black-primary pt-20">
          ...
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6">
              <span className="bg-gradient-to-r from-rose-gold-light via-rose-gold to-rose-gold-dark bg-clip-text text-transparent">
                Halal Catering Dudley
              </span>
            </h1>
            <p className="text-2xl text-white mb-4">Authentic Halal Pakistani & Indian Cuisine</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              100% halal certified halal catering serving Dudley. Fresh biryani, karahi, tandoori from £15-30pp
            </p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why Dudley Families Choose Our Halal Catering
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">Dudley Catering Challenge</h3>
                <p className="text-gray-300 leading-relaxed">
                  Finding authentic halal halal catering in Dudley with fresh Pakistani and Indian food can be difficult. Many caterers use frozen food, lack proper halal certification, or charge premium prices for poor quality.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Dudley families authentic halal halal catering prepared fresh daily with 100% certified ingredients. Traditional recipes, generous portions, transparent pricing, and reliable delivery across Dudley.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Complete Catering Solution for Dudley
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">
                  Hot food delivered across Dudley. Professional setup. Free delivery 30+ guests.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Transparent Pricing for Dudley
            </h2>
            ...
            <p className="text-gray-400 text-sm text-center mt-6">
              *Minimum 15 guests. Free delivery for 30+ guests in Dudley
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Delivery Across Dudley & West Midlands
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
              ...
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
                    <span><strong className="text-white">Dudley:</strong> All areas covered</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why LUXE VENUE for Dudley Catering
            </h2>
            <div className="overflow-x-auto">
              <table className="w-full bg-surface-dark rounded-xl border border-white/10">
                <thead>
