...
export const metadata: Metadata = {
  title: 'Wedding Venue Dudley | Affordable Venue Hire from £400 | LUXE VENUE',
  description: 'Premium wedding venue in Dudley. Capacity 20-70 guests. Halal catering, parking, full equipment. Book your Dudley wedding venue today.',
  keywords: 'wedding venue dudley, wedding venue near me dudley, best wedding venue dudley, affordable wedding venue dudley, halal wedding venue dudley',
  alternates: { canonical: 'https://luxevenue.co.uk/wedding-venue-dudley' },
  openGraph: {
    title: 'Wedding Venue Dudley | LUXE VENUE',
    description: 'Elegant wedding venue in Dudley. 20-70 capacity. Halal catering available.',
    url: 'https://luxevenue.co.uk/wedding-venue-dudley',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function WeddingVenueDudleyPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'LUXE VENUE - Wedding Venue Dudley',
    description: 'Premium wedding venue in Dudley with halal catering, parking, and full event equipment.',
    url: 'https://luxevenue.co.uk/wedding-venue-dudley',
  ...
  const eventVenueSchema = {
    ...
    description: 'Wedding Venue space serving Dudley',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does wedding venue cost in Dudley?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Wedding Venue hire at LUXE VENUE for Dudley clients starts from £500-£900. Our packages include venue hire, basic décor, LED lighting, A/V system, and optional halal catering from £25pp.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the capacity for wedding venue in Dudley?',
        acceptedAnswer: {
          '@type': 'Answer',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Wedding Venue Dudley', item: 'https://luxevenue.co.uk/wedding-venue-dudley' }
    ]
  }
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black-primary to-black-secondary">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Premium wedding venue serving Dudley with halal catering, free parking, and full equipment from £500-£900
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding an affordable, elegant wedding venue in Dudley that offers halal catering, adequate parking, and modern facilities can be challenging. Many venues charge premium prices without delivering culturally sensitive service.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Dudley families a premium wedding venue with authentic Pakistani and Indian halal catering, flexible layouts, on-site parking, and transparent pricing. Perfect for Asian and Muslim community celebrations.
                </p>
              </div>
            </div>
          </div>
