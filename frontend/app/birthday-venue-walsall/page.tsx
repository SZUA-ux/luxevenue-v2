...
export const metadata: Metadata = {
  title: 'Birthday Venue Walsall | Affordable Venue Hire from £400 | LUXE VENUE',
  description: 'Premium birthday venue in Walsall. Capacity 30-70 guests. Halal catering, parking, full equipment. Book your Walsall birthday venue today.',
  keywords: 'birthday venue walsall, birthday venue near me walsall, best birthday venue walsall, affordable birthday venue walsall, halal birthday venue walsall',
  alternates: { canonical: 'https://luxevenue.co.uk/birthday-venue-walsall' },
  openGraph: {
    title: 'Birthday Venue Walsall | LUXE VENUE',
    description: 'Elegant birthday venue in Walsall. 30-70 capacity. Halal catering available.',
    url: 'https://luxevenue.co.uk/birthday-venue-walsall',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function BirthdayVenueWalsallPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'LUXE VENUE - Birthday Venue Walsall',
    description: 'Premium birthday venue in Walsall with halal catering, parking, and full event equipment.',
    url: 'https://luxevenue.co.uk/birthday-venue-walsall',
  ...
  const eventVenueSchema = {
    ...
    description: 'Birthday Venue space serving Walsall',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does birthday venue cost in Walsall?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Birthday Venue hire at LUXE VENUE for Walsall clients starts from £500-£800. Our packages include venue hire, basic décor, LED lighting, A/V system, and optional halal catering from £25pp.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the capacity for birthday venue in Walsall?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'LUXE VENUE accommodates 30-70 guests comfortably for Walsall events. Our flexible layout can be configured for seated dining, standing reception, or mixed arrangements.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Birthday Venue Walsall', item: 'https://luxevenue.co.uk/birthday-venue-walsall' }
    ]
  }
      ...
      <main className="min-h-screen bg-black-primary pt-20">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black-primary to-black-secondary">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-2xl text-white mb-4">Elegant Venue for 30-70 Guests</p>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Premium birthday venue serving Walsall with halal catering, free parking, and full equipment from £500-£800
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding an affordable, elegant birthday venue in Walsall that offers halal catering, adequate parking, and modern facilities can be challenging. Many venues charge premium prices without delivering culturally sensitive service.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Walsall families a premium birthday venue with authentic Pakistani and Indian halal catering, flexible layouts, on-site parking, and transparent pricing. Perfect for Asian and Muslim community celebrations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">
                  Elegant space with 30-70 capacity, professional lighting, A/V system, and flexible seating
                </p>
              </div>
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10">
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                      ...
                      <span><strong className="text-white">Maximum Capacity:</strong> 30-70 guests</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-rose-gold mr-2">✓</span>
