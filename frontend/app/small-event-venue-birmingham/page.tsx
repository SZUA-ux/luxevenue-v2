...
export const metadata: Metadata = {
  title: 'Small Event Venue Birmingham | Affordable Venue Hire from £400 | LUXE VENUE',
  description: 'Premium small event venue in Birmingham. Capacity 20-50 guests. Halal catering, parking, full equipment. Book your Birmingham small event venue today.',
  keywords: 'small event venue birmingham, small event venue near me birmingham, best small event venue birmingham, affordable small event venue birmingham, halal small event venue birmingham',
  alternates: { canonical: 'https://luxevenue.co.uk/small-event-venue-birmingham' },
  openGraph: {
    title: 'Small Event Venue Birmingham | LUXE VENUE',
    description: 'Elegant small event venue in Birmingham. 20-50 capacity. Halal catering available.',
    url: 'https://luxevenue.co.uk/small-event-venue-birmingham',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function SmallEventVenueBirminghamPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'LUXE VENUE - Small Event Venue Birmingham',
    description: 'Premium small event venue in Birmingham with halal catering, parking, and full event equipment.',
    url: 'https://luxevenue.co.uk/small-event-venue-birmingham',
  ...
  const eventVenueSchema = {
    '@context': 'https://schema.org',
    '@type': 'EventVenue',
    name: 'LUXE VENUE Birmingham',
    description: 'Small Event Venue space serving Birmingham',
    maximumAttendeeCapacity: 50,
    address: { '@type': 'PostalAddress', addressLocality: 'Birmingham', addressRegion: 'West Midlands' }
  }
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does small event venue cost in Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Small Event Venue hire at LUXE VENUE for Birmingham clients starts from £400-£700. Our packages include venue hire, basic décor, LED lighting, A/V system, and optional halal catering from £25pp.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the capacity for small event venue in Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'LUXE VENUE accommodates 20-50 guests comfortably for Birmingham events. Our flexible layout can be configured for seated dining, standing reception, or mixed arrangements.'
        }
      },
      {
        '@type': 'Question',
        name: 'Do you provide halal catering for Birmingham events?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes! We offer complete halal catering packages featuring authentic Pakistani and Indian cuisine for Birmingham clients. All food is 100% halal certified with vegetarian and vegan options.'
        }
      },
      {
        '@type': 'Question',
        name: 'Is parking available for Birmingham guests?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes, we provide on-site parking for up to 15 vehicles with additional street parking. Located in Birmingham city centre, easily accessible for Birmingham guests.'
        }
      },
      {
        '@type': 'Question',
        name: 'How do I book from Birmingham?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We welcome Birmingham clients to book free venue viewings 7 days a week. Contact us at +44 7391 222884 or use our online booking form.'
        }
      }
    ]
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Small Event Venue Birmingham', item: 'https://luxevenue.co.uk/small-event-venue-birmingham' }
    ]
  }
    ...
    <>
      ...
      <main className="min-h-screen bg-black-primary pt-20">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black-primary to-black-secondary">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Premium small event venue serving Birmingham with halal catering, free parking, and full equipment from £400-£700
            </p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Why Birmingham Families Choose LUXE VENUE
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">Birmingham Event Challenge</h3>
                <p className="text-gray-300 leading-relaxed">
                  Finding an affordable, elegant small event venue in Birmingham that offers halal catering, adequate parking, and modern facilities can be challenging. Many venues charge premium prices without delivering culturally sensitive service.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Birmingham families a premium small event venue with authentic Pakistani and Indian halal catering, flexible layouts, on-site parking, and transparent pricing. Perfect for Asian and Muslim community celebrations.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Complete Event Solution for Birmingham
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-surface-elevated p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 text-sm">
                  15+ on-site spaces with additional street parking. Easy access from Birmingham
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black-secondary">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-xl text-gray-300 text-center mb-12 max-w-3xl mx-auto">
              Complete your Birmingham event with award-winning Pakistani and Indian halal catering
            </p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-heading font-bold text-white mb-8 text-center">
              Location & Access from Birmingham
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
                    <span><strong className="text-white">Distance:</strong> in the city</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
              ...
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
                    <span><strong className="text-white">Bus:</strong> Multiple routes from Birmingham</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-rose-gold mr-2">✓</span>
                    <span><strong className="text-white">Taxi:</strong> £10-20 from Birmingham centre</span>
                  </li>
                </ul>
              </div>
            </div>
