...
export const metadata: Metadata = {
  title: 'Affordable Venue Hire Dudley | Affordable Venue Hire from £400 | LUXE VENUE',
  description: 'Premium affordable venue hire in Dudley. Capacity 20-70 guests. Halal catering, parking, full equipment. Book your Dudley affordable venue hire today.',
  keywords: 'affordable venue hire dudley, affordable venue hire near me dudley, best affordable venue hire dudley, affordable affordable venue hire dudley, halal affordable venue hire dudley',
  alternates: { canonical: 'https://luxevenue.co.uk/affordable-venue-hire-dudley' },
  openGraph: {
    title: 'Affordable Venue Hire Dudley | LUXE VENUE',
    description: 'Elegant affordable venue hire in Dudley. 20-70 capacity. Halal catering available.',
    url: 'https://luxevenue.co.uk/affordable-venue-hire-dudley',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function AffordableVenueHireDudleyPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'LUXE VENUE - Affordable Venue Hire Dudley',
    description: 'Premium affordable venue hire in Dudley with halal catering, parking, and full event equipment.',
    url: 'https://luxevenue.co.uk/affordable-venue-hire-dudley',
  ...
  const eventVenueSchema = {
    ...
    description: 'Affordable Venue Hire space serving Dudley',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does affordable venue hire cost in Dudley?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Affordable Venue Hire hire at LUXE VENUE for Dudley clients starts from £400-£700. Our packages include venue hire, basic décor, LED lighting, A/V system, and optional halal catering from £25pp.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the capacity for affordable venue hire in Dudley?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'LUXE VENUE accommodates 20-70 guests comfortably for Dudley events. Our flexible layout can be configured for seated dining, standing reception, or mixed arrangements.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Affordable Venue Hire Dudley', item: 'https://luxevenue.co.uk/affordable-venue-hire-dudley' }
    ]
  }
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black-primary to-black-secondary">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Premium affordable venue hire serving Dudley with halal catering, free parking, and full equipment from £400-£700
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding an affordable, elegant affordable venue hire in Dudley that offers halal catering, adequate parking, and modern facilities can be challenging. Many venues charge premium prices without delivering culturally sensitive service.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Dudley families a premium affordable venue hire with authentic Pakistani and Indian halal catering, flexible layouts, on-site parking, and transparent pricing. Perfect for Asian and Muslim community celebrations.
                </p>
              </div>
            </div>
          </div>
