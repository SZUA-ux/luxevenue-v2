...
export const metadata: Metadata = {
  title: 'Birthday Venue Solihull | Affordable Venue Hire from £400 | LUXE VENUE',
  description: 'Premium birthday venue in Solihull. Capacity 30-70 guests. Halal catering, parking, full equipment. Book your Solihull birthday venue today.',
  keywords: 'birthday venue solihull, birthday venue near me solihull, best birthday venue solihull, affordable birthday venue solihull, halal birthday venue solihull',
  alternates: { canonical: 'https://luxevenue.co.uk/birthday-venue-solihull' },
  openGraph: {
    title: 'Birthday Venue Solihull | LUXE VENUE',
    description: 'Elegant birthday venue in Solihull. 30-70 capacity. Halal catering available.',
    url: 'https://luxevenue.co.uk/birthday-venue-solihull',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function BirthdayVenueSolihullPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'LUXE VENUE - Birthday Venue Solihull',
    description: 'Premium birthday venue in Solihull with halal catering, parking, and full event equipment.',
    url: 'https://luxevenue.co.uk/birthday-venue-solihull',
  ...
  const eventVenueSchema = {
    ...
    description: 'Birthday Venue space serving Solihull',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does birthday venue cost in Solihull?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Birthday Venue hire at LUXE VENUE for Solihull clients starts from £500-£800. Our packages include venue hire, basic décor, LED lighting, A/V system, and optional halal catering from £25pp.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the capacity for birthday venue in Solihull?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'LUXE VENUE accommodates 30-70 guests comfortably for Solihull events. Our flexible layout can be configured for seated dining, standing reception, or mixed arrangements.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Birthday Venue Solihull', item: 'https://luxevenue.co.uk/birthday-venue-solihull' }
    ]
  }
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black-primary to-black-secondary">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Premium birthday venue serving Solihull with halal catering, free parking, and full equipment from £500-£800
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding an affordable, elegant birthday venue in Solihull that offers halal catering, adequate parking, and modern facilities can be challenging. Many venues charge premium prices without delivering culturally sensitive service.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Solihull families a premium birthday venue with authentic Pakistani and Indian halal catering, flexible layouts, on-site parking, and transparent pricing. Perfect for Asian and Muslim community celebrations.
                </p>
              </div>
            </div>
          </div>
