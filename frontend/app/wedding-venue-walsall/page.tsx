...
export const metadata: Metadata = {
  title: 'Wedding Venue Walsall | Affordable Venue Hire from £400 | LUXE VENUE',
  description: 'Premium wedding venue in Walsall. Capacity 20-70 guests. Halal catering, parking, full equipment. Book your Walsall wedding venue today.',
  keywords: 'wedding venue walsall, wedding venue near me walsall, best wedding venue walsall, affordable wedding venue walsall, halal wedding venue walsall',
  alternates: { canonical: 'https://luxevenue.co.uk/wedding-venue-walsall' },
  openGraph: {
    title: 'Wedding Venue Walsall | LUXE VENUE',
    description: 'Elegant wedding venue in Walsall. 20-70 capacity. Halal catering available.',
    url: 'https://luxevenue.co.uk/wedding-venue-walsall',
    siteName: 'LUXE VENUE',
    locale: 'en_GB',
    type: 'website',
  },
...
export default function WeddingVenueWalsallPage() {
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: 'LUXE VENUE - Wedding Venue Walsall',
    description: 'Premium wedding venue in Walsall with halal catering, parking, and full event equipment.',
    url: 'https://luxevenue.co.uk/wedding-venue-walsall',
  ...
  const eventVenueSchema = {
    ...
    description: 'Wedding Venue space serving Walsall',
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does wedding venue cost in Walsall?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Wedding Venue hire at LUXE VENUE for Walsall clients starts from £500-£900. Our packages include venue hire, basic décor, LED lighting, A/V system, and optional halal catering from £25pp.'
        }
      },
      {
        '@type': 'Question',
        name: 'What is the capacity for wedding venue in Walsall?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'LUXE VENUE accommodates 20-70 guests comfortably for Walsall events. Our flexible layout can be configured for seated dining, standing reception, or mixed arrangements.'
        }
      },
      {
        '@type': 'Question',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Wedding Venue Walsall', item: 'https://luxevenue.co.uk/wedding-venue-walsall' }
    ]
  }
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black-primary to-black-secondary">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Premium wedding venue serving Walsall with halal catering, free parking, and full equipment from £500-£900
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Finding an affordable, elegant wedding venue in Walsall that offers halal catering, adequate parking, and modern facilities can be challenging. Many venues charge premium prices without delivering culturally sensitive service.
                </p>
              </div>
              <div className="bg-surface-dark p-8 rounded-xl border border-white/10">
                <h3 className="text-2xl font-bold text-white mb-4">LUXE VENUE Solution</h3>
                <p className="text-gray-300 leading-relaxed">
                  LUXE VENUE offers Walsall families a premium wedding venue with authentic Pakistani and Indian halal catering, flexible layouts, on-site parking, and transparent pricing. Perfect for Asian and Muslim community celebrations.
                </p>
              </div>
            </div>
          </div>
